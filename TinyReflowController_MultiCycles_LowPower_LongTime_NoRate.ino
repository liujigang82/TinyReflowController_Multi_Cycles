...
#define CYCLE_TIME 3
#define REFLOW_HOLD_TIME 60000//2*60*60*1000
#define COOLING_HOLD_TIME 120000 //2*60*60*1000
#define ONE_MINUTE 60000
#define RAMP_RATE  8
#define COOLING_1_RATE  0.9
#define COOLING_2_RATE  8

// ***** GENERAL PROFILE CONSTANTS *****
#define PROFILE_TYPE_ADDRESS 0
#define TEMPERATURE_ROOM 50       //50
#define TEMPERATURE_SOAK_MIN 55  //150
#define TEMPERATURE_COOL_MIN 60 //100
#define TEMPERATURE_COOL_2_MIN 55
#define SENSOR_SAMPLING_TIME 1000
#define SOAK_TEMPERATURE_STEP 5

// ***** LEAD FREE PROFILE CONSTANTS *****
#define TEMPERATURE_SOAK_MAX_LF 65     //200
#define TEMPERATURE_REFLOW_MAX_LF 75 //250
#define SOAK_MICRO_PERIOD_LF 9000

// ***** LEADED PROFILE CONSTANTS *****
#define TEMPERATURE_SOAK_MAX_PB 50    //180
#define TEMPERATURE_REFLOW_MAX_PB 65 //224
...
#define PID_KI_PREHEAT 200
#define PID_KD_PREHEAT 20
// ***** SOAKING STAGE *****
#define PID_KP_SOAK 300
#define PID_KI_SOAK 200
...
// ***** Cooling STAGE 2 *****
#define PID_KP_COOL2 300
#define PID_KI_COOL2 200
#define PID_KD_COOL2 350
...
unsigned long startRamp_rate_time = 0;
unsigned long startCooling_1_rate_time = 0;
unsigned long startCooling_2_rate_time = 0;
...
void loop()
{
    ...
    if (millis() > nextCheck)
    {
        ...
        if (reflowStatus == REFLOW_STATUS_ON)
        {
            ...
            Serial.print(output);
            Serial.print(", ");
            Serial.print(millis()- startReflow);
            Serial.print(", ");
            Serial.print(millis()- startCooling);
            Serial.print(", ");
            Serial.print(REFLOW_HOLD_TIME);
            Serial.print(", ");
            Serial.println(COOLING_HOLD_TIME);
    ...
    switch (reflowState)
    {
        case REFLOW_STATE_IDLE:
            ...
            else
            {
                ...
                if (switchStatus == SWITCH_1)
                {
                    ...
                    Serial.println("Time, ReflowState, Setpoint, CurrentTemperature, Output, ReflowHoldTime");
        ...
        case REFLOW_STATE_COOL:
            ...
            if (input <= TEMPERATURE_COOL_MIN && millis() - startCooling >= COOLING_HOLD_TIME)
            {
                ...
                startCooling = 0;
                reflowState = REFLOW_STATE_COOL_2;
            }
            break;
